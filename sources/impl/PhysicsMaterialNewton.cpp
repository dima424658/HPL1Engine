...
namespace hpl {
	...
	int cPhysicsMaterialNewton::OnAABBOverlapCallback(const NewtonMaterial* material,
	...
	void cPhysicsMaterialNewton::ContactsProcessCallback(const NewtonJoint* apJoint,
		float afTimeStep,
		int alThreadIndex)
	{
